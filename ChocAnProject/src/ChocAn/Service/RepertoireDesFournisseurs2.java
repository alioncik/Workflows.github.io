...
public class RepertoireDesFournisseurs2 {
	
	Service2[] listeServices = new Service2[16];
	 ...
	 */
	public Service2 trouverService(int codeService) throws Exception {
	 ...
	 */
	public void ajouterService(Service2 service){
	 ...
	 */
	public Service2[] trierListeAlpha() throws Exception {
	...
	public void doubleListe(){
		...
		Service2[] listeTemp = new Service2[this.listeServices.length*2];
