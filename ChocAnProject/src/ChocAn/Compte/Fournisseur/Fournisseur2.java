...
public class Fournisseur2 extends Compte {
...
private static int compteur = 0;	//Compteur statique du nombre de Fournisseur créé au total. Utilisé pour générer les numéros de Fournisseur.
	 ...
	 */
	public Fournisseur2 (String nom, String adresse, String ville, String province, String codePostal, String email) {
		
		super (nom, adresse, ville, province, codePostal, email);
		
		Fournisseur2.compteur++;
	...
	protected int genererNumero(){
		...
		int numero = Fournisseur2.compteur * 15485863 % 99999999;
